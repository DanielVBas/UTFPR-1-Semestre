...
void menuInicJogo(Tab *tabuleiro)
{
    ...
    case 1:   
        inicBloco(tabuleiro); 
        strcpy(tabuleiro->nomeJogo, "Bloco"); break;
    case 2:   
        inicBlinker(tabuleiro);
        strcpy(tabuleiro->nomeJogo, "Blinker"); break;
    case 3:   
        inicSapo(tabuleiro);
        strcpy(tabuleiro->nomeJogo, "Sapo"); break;
    case 4:   
        inicGlider(tabuleiro);
        strcpy(tabuleiro->nomeJogo, "Glider"); break;
    case 5:   
        inicLWSS(tabuleiro);
        strcpy(tabuleiro->nomeJogo, "LWSS"); break;
    }
